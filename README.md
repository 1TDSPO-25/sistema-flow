...
<ul style="color:green">
 ...
 <li>[ x ] FEATURE / Criar o projeto (VITE+REACT+TS) do zero / Prof.Alexandre-Estalise</li>
</ul>
...
<ul style="color:orange">
   <li> ...</li>
<li>[   ] FEATURE / Limpar o boiler-plate e instalar os pacotes react-router-dom, tailwindcss, json-server, react-icons, react-use-form/Crevelari </li>
<li>[   ] FEATURE / Criar uma api com json-server, o endpoint de nome usuarios, os dados do endpoint são [id,nome,nomeUser,email,avatar]/Soteras-Sabelli-Gustavo</li>
...
<li>Atualizar os Cards de Produto (na Home e em <code>/produtos</code>) para linkarem para esta página.</li> / <strong>Time: Alef - Paulo - Emanuel</strong> </li>
</ul>
...
<li>[   ] <strong>FEATURE / Criar Estado Global do Carrinho (Context API):</strong> 
 <li>Criar um <code>CartContext.tsx</code>. Ele deve gerenciar o estado do carrinho (lista de produtos, quantidade) e prover funções para <code>adicionarProduto</code>, <code>removerProduto</code>, e <code>atualizarQuantidade</code>.</li> / <strong>Time: Diego - Matheus A.</strong> </li>
