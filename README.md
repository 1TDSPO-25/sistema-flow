...
<ul style="color:blue"> <li>[   ] <strong>FEATURE / Criar Estado Global do Carrinho (Context API):</strong> <ul> <li>Criar um <code>CartContext.tsx</code>. Ele deve gerenciar o estado do carrinho (lista de produtos, quantidade) e prover funções para <code>adicionarProduto</code>, <code>removerProduto</code>, e <code>atualizarQuantidade</code>.</li> </ul> / <strong>Time: Diego - Matheus A.</strong> </li>
</ul>
